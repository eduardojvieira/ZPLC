...
El manifiesto solo define el contrato de navegación. La verdad de APIs del runtime, placas,
workflows del IDE y alcance del release vive en los archivos mapeados por
